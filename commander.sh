  ...
  if [[ $REPLY =~ ^[1-4]{1} ]]; then
    case $REPLY in
      ...
      1b)
        ...
        ;;
      2a)
        docker-compose -f ../BANKING/docker-compose.yml run --rm banking-php php artisan migrate --env=docker
        post_message
        ;;
      2b)
        docker-compose -f ../BANKING/docker-compose.yml run --rm banking-php php artisan db:seed --env=docker
        post_message
        ;;
      2c)
        docker-compose -f ../BANKING/docker-compose.yml run --rm banking-php php artisan cache:clear --env=docker
        post_message
        ;;
      2d)
        docker-compose -f ../BANKING/docker-compose.yml run --rm banking-php php artisan route:clear --env=docker
        post_message
        ;;
      3)
